...
Drob = 117.2;  # space between both wheels in m
...
satisfactory_area = 1  # circle around target in m
...
def update_error_vector(current_pos: tuple[float, float, float],
                        target_pos: tuple[float, float, float]):  # error vector

...
# Load path points
# path_points = np.load("robot_path.npy") 
path_points = [(0, 0, "r"), (20, 100, "r"), (50, 235, "r"), (80, 122, "y"), (343, 162, "y"), (85, 1, "y"), (6, 3, "b"), (27, -10, "b"),  (45, -16, "b"),  (57, -30, "b"),  (48, -60, "b")]  # Example points with colors
